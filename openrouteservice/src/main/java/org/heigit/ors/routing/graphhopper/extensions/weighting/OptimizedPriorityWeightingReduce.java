...
public class OptimizedPriorityWeightingReduce extends FastestWeighting {
	...
	public OptimizedPriorityWeightingReduce(FlagEncoder encoder, PMap map) {
		super(encoder, map);
	...
	public double calcWeight(EdgeIteratorState edgeState, boolean reverse, int prevOrNextEdgeId) {
		...
		if (priority <= THRESHOLD_AVOID_IF_POSSIBLE)
			weight *= 1.25;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final OptimizedPriorityWeightingReduce other = (OptimizedPriorityWeightingReduce) obj;
		return toString().equals(other.toString());
	}

	@Override
	public int hashCode() {
		return ("OptimizedPriorityWeightingReduce" + toString()).hashCode();
	}
