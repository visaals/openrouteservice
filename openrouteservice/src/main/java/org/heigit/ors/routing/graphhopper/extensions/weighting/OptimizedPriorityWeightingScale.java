...
public class OptimizedPriorityWeightingScale extends FastestWeighting {
	...
	public OptimizedPriorityWeightingScale(FlagEncoder encoder, PMap map) {
		super(encoder, map);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final OptimizedPriorityWeightingScale other = (OptimizedPriorityWeightingScale) obj;
		return toString().equals(other.toString());
	}

	@Override
	public int hashCode() {
		return ("OptimizedPriorityWeightingScale" + toString()).hashCode();
	}
